...
function NewTaskModal({ show, closeModal, setTodo, todo }) {
    ...
    const handleSubmit = async ()=>{
        try {
            ...
            console.log(task);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$ToDoServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["postToDo"])(task);
            closeModal(!show);
        } catch (e) {
            console.log(e);
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NewTaskModal.useEffect": ()=>{
            const fetchKrw = {
                "NewTaskModal.useEffect.fetchKrw": async ()=>{
                    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$ToDoServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToDo"])();
                    setTodo(res);
                }
            }["NewTaskModal.useEffect.fetchKrw"];
            fetchKrw();
        }
    }["NewTaskModal.useEffect"], [
        setTodo
...
_s(NewTaskModal, "MI3XvUrEYgHf0Ax3NA7wnAofCgs=");
_c = NewTaskModal;
...
function page() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "page.useEffect": ()=>{
            const fetchTasks = {
                "page.useEffect.fetchTasks": async ()=>{
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$ToDoServices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToDo"])();
                        setTodo(data);
                    } catch (e) {
...
_s(page, "REumOPTiowEMrU0u8Fb9pIxOC50=");
...
//# sourceMappingURL=_34b1ff77._.js.map